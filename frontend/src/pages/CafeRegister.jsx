...
import { auth, googleProvider, signInWithPopup, createUserWithEmailAndPassword } from '../config/firebase';
      ...
      <main className="flex-1 flex items-center justify-center p-4 py-12">
        <div className="w-full max-w-lg glass-card rounded-2xl p-8 border border-slate-800 shadow-2xl">
          ...
          <div className="relative flex py-2 items-center mb-6">
            ...
            <span className="flex-shrink mx-4 text-xs font-semibold text-slate-500">OR EMAIL REGISTRATION</span>
            <div className="flex-grow border-t border-slate-800"></div>
          </div>
